...
[ ](https://arxiv.org/abs/2511.17592v1) [ ](javascript:toggleColorScheme\(\) "Toggle dark/light mode")
...
[Why HTML?](https://info.arxiv.org/about/accessible_HTML.html) [Report Issue](/html/2511.17592v1/#myForm) [Back to Abstract](https://arxiv.org/abs/2511.17592v1) [Download PDF](https://arxiv.org/pdf/2511.17592v1) [ ](javascript:toggleColorScheme\(\) "Toggle dark/light mode")
## Table of Contents
  1. [ ](https://arxiv.org/html/2511.17592v1#abstract "Abstract")
  2. [1 Introduction](https://arxiv.org/html/2511.17592v1#S1 "In GigaEvo: An Open Source Optimization Framework Powered by LLMs and Evolution Algorithms")
  3. [2 System Design](https://arxiv.org/html/2511.17592v1#S2 "In GigaEvo: An Open Source Optimization Framework Powered by LLMs and Evolution Algorithms")
    1. [Redis Database.](https://arxiv.org/html/2511.17592v1#S2.SS0.SSS0.Px1 "In 2 System Design ‣ GigaEvo: An Open Source Optimization Framework Powered by LLMs and Evolution Algorithms")
    2. [DAG Execution Engine.](https://arxiv.org/html/2511.17592v1#S2.SS0.SSS0.Px2 "In 2 System Design ‣ GigaEvo: An Open Source Optimization Framework Powered by LLMs and Evolution Algorithms")
    3. [Evolutionary Engine.](https://arxiv.org/html/2511.17592v1#S2.SS0.SSS0.Px3 "In 2 System Design ‣ GigaEvo: An Open Source Optimization Framework Powered by LLMs and Evolution Algorithms")
    4. [Mutation Operator.](https://arxiv.org/html/2511.17592v1#S2.SS0.SSS0.Px4 "In 2 System Design ‣ GigaEvo: An Open Source Optimization Framework Powered by LLMs and Evolution Algorithms")
    5. [Flexible configuration system.](https://arxiv.org/html/2511.17592v1#S2.SS0.SSS0.Px5 "In 2 System Design ‣ GigaEvo: An Open Source Optimization Framework Powered by LLMs and Evolution Algorithms")
    6. [Problem specification interface.](https://arxiv.org/html/2511.17592v1#S2.SS0.SSS0.Px6 "In 2 System Design ‣ GigaEvo: An Open Source Optimization Framework Powered by LLMs and Evolution Algorithms")
  4. [3 Experimental setup](https://arxiv.org/html/2511.17592v1#S3 "In GigaEvo: An Open Source Optimization Framework Powered by LLMs and Evolution Algorithms")
    1. [Insight generation.](https://arxiv.org/html/2511.17592v1#S3.SS0.SSS0.Px1 "In 3 Experimental setup ‣ GigaEvo: An Open Source Optimization Framework Powered by LLMs and Evolution Algorithms")
    2. [Lineage analysis.](https://arxiv.org/html/2511.17592v1#S3.SS0.SSS0.Px2 "In 3 Experimental setup ‣ GigaEvo: An Open Source Optimization Framework Powered by LLMs and Evolution Algorithms")
    3. [Mutation context assembly.](https://arxiv.org/html/2511.17592v1#S3.SS0.SSS0.Px3 "In 3 Experimental setup ‣ GigaEvo: An Open Source Optimization Framework Powered by LLMs and Evolution Algorithms")
  5. [4 Benchmark problems](https://arxiv.org/html/2511.17592v1#S4 "In GigaEvo: An Open Source Optimization Framework Powered by LLMs and Evolution Algorithms")
    1. [4.1 Heilbronn triangle problem.](https://arxiv.org/html/2511.17592v1#S4.SS1 "In 4 Benchmark problems ‣ GigaEvo: An Open Source Optimization Framework Powered by LLMs and Evolution Algorithms")
      1. [Results.](https://arxiv.org/html/2511.17592v1#S4.SS1.SSS0.Px1 "In 4.1 Heilbronn triangle problem. ‣ 4 Benchmark problems ‣ GigaEvo: An Open Source Optimization Framework Powered by LLMs and Evolution Algorithms")
      2. [Circle packing in a square.](https://arxiv.org/html/2511.17592v1#S4.SS1.SSS0.Px2 "In 4.1 Heilbronn triangle problem. ‣ 4 Benchmark problems ‣ GigaEvo: An Open Source Optimization Framework Powered by LLMs and Evolution Algorithms")
      3. [Results.](https://arxiv.org/html/2511.17592v1#S4.SS1.SSS0.Px3 "In 4.1 Heilbronn triangle problem. ‣ 4 Benchmark problems ‣ GigaEvo: An Open Source Optimization Framework Powered by LLMs and Evolution Algorithms")
    2. [4.2 Kissing numbers in high dimensions.](https://arxiv.org/html/2511.17592v1#S4.SS2 "In 4 Benchmark problems ‣ GigaEvo: An Open Source Optimization Framework Powered by LLMs and Evolution Algorithms")
      1. [Results.](https://arxiv.org/html/2511.17592v1#S4.SS2.SSS0.Px1 "In 4.2 Kissing numbers in high dimensions. ‣ 4 Benchmark problems ‣ GigaEvo: An Open Source Optimization Framework Powered by LLMs and Evolution Algorithms")
    3. [4.3 Bin Packing](https://arxiv.org/html/2511.17592v1#S4.SS3 "In 4 Benchmark problems ‣ GigaEvo: An Open Source Optimization Framework Powered by LLMs and Evolution Algorithms")
      1. [Problem formulation.](https://arxiv.org/html/2511.17592v1#S4.SS3.SSS0.Px1 "In 4.3 Bin Packing ‣ 4 Benchmark problems ‣ GigaEvo: An Open Source Optimization Framework Powered by LLMs and Evolution Algorithms")
      2. [Experimental setup.](https://arxiv.org/html/2511.17592v1#S4.SS3.SSS0.Px2 "In 4.3 Bin Packing ‣ 4 Benchmark problems ‣ GigaEvo: An Open Source Optimization Framework Powered by LLMs and Evolution Algorithms")
      3. [Results.](https://arxiv.org/html/2511.17592v1#S4.SS3.SSS0.Px3 "In 4.3 Bin Packing ‣ 4 Benchmark problems ‣ GigaEvo: An Open Source Optimization Framework Powered by LLMs and Evolution Algorithms")
    4. [4.4 Prompt and Agent Evolution](https://arxiv.org/html/2511.17592v1#S4.SS4 "In 4 Benchmark problems ‣ GigaEvo: An Open Source Optimization Framework Powered by LLMs and Evolution Algorithms")
      1. [Problem Formulation.](https://arxiv.org/html/2511.17592v1#S4.SS4.SSS0.Px1 "In 4.4 Prompt and Agent Evolution ‣ 4 Benchmark problems ‣ GigaEvo: An Open Source Optimization Framework Powered by LLMs and Evolution Algorithms")
      2. [Experimental Setup.](https://arxiv.org/html/2511.17592v1#S4.SS4.SSS0.Px2 "In 4.4 Prompt and Agent Evolution ‣ 4 Benchmark problems ‣ GigaEvo: An Open Source Optimization Framework Powered by LLMs and Evolution Algorithms")
      3. [Results.](https://arxiv.org/html/2511.17592v1#S4.SS4.SSS0.Px3 "In 4.4 Prompt and Agent Evolution ‣ 4 Benchmark problems ‣ GigaEvo: An Open Source Optimization Framework Powered by LLMs and Evolution Algorithms")
  6. [5 Conclusions](https://arxiv.org/html/2511.17592v1#S5 "In GigaEvo: An Open Source Optimization Framework Powered by LLMs and Evolution Algorithms")
    1. [Implementation insights.](https://arxiv.org/html/2511.17592v1#S5.SS0.SSS0.Px1 "In 5 Conclusions ‣ GigaEvo: An Open Source Optimization Framework Powered by LLMs and Evolution Algorithms")
    2. [Limitations and future work.](https://arxiv.org/html/2511.17592v1#S5.SS0.SSS0.Px2 "In 5 Conclusions ‣ GigaEvo: An Open Source Optimization Framework Powered by LLMs and Evolution Algorithms")
    3. [Broader impact.](https://arxiv.org/html/2511.17592v1#S5.SS0.SSS0.Px3 "In 5 Conclusions ‣ GigaEvo: An Open Source Optimization Framework Powered by LLMs and Evolution Algorithms")
  7. [A Heilbronn Triangle Problem: Task Description and Evolved Solution](https://arxiv.org/html/2511.17592v1#A1 "In GigaEvo: An Open Source Optimization Framework Powered by LLMs and Evolution Algorithms")
    1. [A.1 Task Description](https://arxiv.org/html/2511.17592v1#A1.SS1 "In Appendix A Heilbronn Triangle Problem: Task Description and Evolved Solution ‣ GigaEvo: An Open Source Optimization Framework Powered by LLMs and Evolution Algorithms")
    2. [A.2 Evolved Solution Code](https://arxiv.org/html/2511.17592v1#A1.SS2 "In Appendix A Heilbronn Triangle Problem: Task Description and Evolved Solution ‣ GigaEvo: An Open Source Optimization Framework Powered by LLMs and Evolution Algorithms")
  8. [B Prompt And Agent Evolution Results](https://arxiv.org/html/2511.17592v1#A2 "In GigaEvo: An Open Source Optimization Framework Powered by LLMs and Evolution Algorithms")
    1. [B.1 Final Prompt](https://arxiv.org/html/2511.17592v1#A2.SS1 "In Appendix B Prompt And Agent Evolution Results ‣ GigaEvo: An Open Source Optimization Framework Powered by LLMs and Evolution Algorithms")
    2. [B.2 Final Agent](https://arxiv.org/html/2511.17592v1#A2.SS2 "In Appendix B Prompt And Agent Evolution Results ‣ GigaEvo: An Open Source Optimization Framework Powered by LLMs and Evolution Algorithms")


[License: CC BY 4.0](https://info.arxiv.org/help/license/index.html#licenses-available)
arXiv:2511.17592v1 [cs.NE] 17 Nov 2025
# GigaEvo: An Open Source Optimization Framework Powered by LLMs and Evolution Algorithms
Report issue for preceding element
Valentin Khrulkov &Andrey V. Galichin∗ &Denis Bashkirov &Dmitry Vinichenko† Artificial Intelligence Research Institute (AIRI), Presnenskaya Embankment 6, bld. 2, Moscow, 123112, Russia. Corresponding author: khrulkov.v@gmail.comSber, 19 Vavilova St., Moscow 117312, Russia Oleg Travkin† &Roman Alferov† &Andrey Kuznetsov∗ &Ivan Oseledets∗
Report issue for preceding element
###### Abstract
Report issue for preceding element
...
Report issue for preceding element
For any n≥3n\geq 3 and any convex body KK in the plane, let C​(n,K)C(n,K) be the largest quantity such that in every configuration of nn points in KK, there exists a triple of points determining a triangle of area at most C​(n,K)C(n,K) times the area of KK. This problem, posed by Heilbronn in the 1950s, asks to establish upper and lower bounds on C​(n,K)C(n,K). Following the discussed paper, we consider the case n=11n=11 with KK being the equilateral triangle of unit area. The function to be evolved proposes point configurations, and the score is the area of the smallest triangle formed by any three points. If constraints are violated, an exception is raised. The target benchmark is the result from novikov2025alphaevolve, which achieved a minimum triangle area of 0.03650.0365 (improving upon the previous best of approximately 0.0360.036 reported in friedman_main_website). The optimization landscape is highly non-convex: small coordinate perturbations can drastically reduce fitness due to near-collinearities or clustering, making this problem particularly challenging for evolutionary search.
Report issue for preceding element
#### Results.
Report issue for preceding element
...
Report issue for preceding element
![Refer to caption](/html/2511.17592v1/heilbronn_results.png) Figure 3: Heilbronn triangle problem results for n=11n=11 points. Left: Point configuration discovered by GigaEvo, maximizing the minimum triangle area formed by any three points in a unit-area equilateral triangle. The evolved program places points both on the boundary and in the interior, exploiting geometric symmetries while avoiding near-collinear triplets. Right: Fitness evolution over 20 evolution generations, showing rapid initial progress followed by refinement. The dashed lines indicate benchmark results: AlphaEvolve achieved 0.03650.0365 (green), while the previous best (friedman_main_website) was approximately 0.0360.036 (red). GigaEvo achieved a fitness of 0.03640.0364, which is 10−410^{-4} below the reported AlphaEvolve result. By visual inspection (fig. 26 left panel in georgiev2025mathematical), the point configurations are nearly identical, suggesting GigaEvo successfully reproduced the AlphaEvolve solution. The small fitness difference could be eliminated with additional computational budget for fine-tuning the simulated annealing parameters in the final optimization phase. This demonstrates that our implementation captures the essential algorithmic principles underlying AlphaEvolve’s success. Report issue for preceding element
#### Circle packing in a square.
Report issue for preceding element
For any n≥1n\geq 1, let C​(n)C(n) denote the largest sum ∑i=1nri\sum_{i=1}^{n}r_{i} of radii such that one can place nn disjoint open disks of radii r1,…,rnr_{1},\dots,r_{n} inside the unit square. Existing upper bounds on this quantity may be found at friedman_main_website. We aim to reproduce the improvements reported in novikov2025alphaevolve, which discovered new constructions advancing these bounds.
Report issue for preceding element
Unlike fixed-radius circle packing, this variable-radius formulation allows the optimizer to explore heterogeneous disk configurations, balancing large disks in open regions against small disks filling interstices. This characteristic makes it particularly suitable for evolutionary search, where incremental improvements emerge through mutation and selection pressure. The system must jointly optimize disk positions and radii while maintaining non-overlap constraints and boundary compliance—a constrained nonlinear optimization problem with complex geometric interactions. We consider n=26n=26 and n=32n=32.
Report issue for preceding element
#### Results.
Report issue for preceding element
We extensively experimented with this task during the preliminary stage of developing our pipeline. Our system achieved and slightly surpassed the reported AlphaEvolve value for n=26n=26; namely, we obtained 2.635982.63598 (compared to the reported value 2.6352.635). A visual representation of this configuration is shown in [fig. 4](https://arxiv.org/html/2511.17592v1#S4.F4 "In Results. ‣ 4.1 Heilbronn triangle problem. ‣ 4 Benchmark problems ‣ GigaEvo: An Open Source Optimization Framework Powered by LLMs and Evolution Algorithms"). By visual inspection, we observe that this configuration is nearly qualitatively identical to the AlphaEvolve result, with marginal improvements likely due to refined optimization of centers and radii. For n=32n=32, our framework achieved a score of 2.9392.939, which is noticeably better than the previous state-of-the-art of 2.9372.937.
Report issue for preceding element
![Refer to caption](/html/2511.17592v1/70a36915-f491-4c7c-94f2-3d27113f7989_99156_visualization.png) Figure 4: Circle packing in unit square for n=26n=26 circles. Optimal configuration discovered by GigaEvo, maximizing the sum of radii ∑i=126ri\sum_{i=1}^{26}r_{i} of disjoint circles packed within the unit square. GigaEvo achieved a total radius sum of 2.6362.636, slightly surpassing the AlphaEvolve result of 2.6352.635 reported in novikov2025alphaevolve. Visual comparison with the AlphaEvolve solution (fig. 28 in georgiev2025mathematical) reveals nearly identical qualitative structure, with minor improvements likely attributable to refined local optimization of centers and radii. This demonstrates that our implementation successfully reproduces and marginally improves upon AlphaEvolve’s results through effective exploration of the constrained geometric optimization landscape. Report issue for preceding element
###  4.2 Kissing numbers in high dimensions.
Report issue for preceding element
For a dimension n≥1n\geq 1, define the _kissing number_ C​(n)C(n) to be the maximum number of non-overlapping unit spheres that can be arranged to simultaneously touch a central unit sphere in nn-dimensional space. This problem has been studied since at least 1694, when Isaac Newton and David Gregory discussed what C​(3)C(3) would be. The cases C​(1)=2C(1)=2 and C​(2)=6C(2)=6 are trivial. The four-dimensional problem was solved by musin2008kissing, who proved that C​(4)=24C(4)=24. In dimensions 8 and 24, the problem is also solved: the E8E_{8} lattice and the Leech lattice give kissing numbers of C​(8)=240C(8)=240 and C​(24)=196560C(24)=196560, respectively. In the report novikov2025alphaevolve, an improved lower bound for C​(11)C(11) was obtained, raising it from 592 to 593. In georgiev2025mathematical, multiple dimensionalities were studied, confirming known lower bounds.
Report issue for preceding element
We adopt the integer lattice formulation employed in _AlphaEvolve_. Lower bounds on C​(n)C(n) are established by constructing explicit configurations of integer vectors satisfying geometric constraints. The task is to find distinct non-zero integer vectors {xi}⊂ℤn\\{x_{i}\\}\subset\mathbb{Z}^{n} such that: (i)  _single shell_ : all vectors lie on a common shell, ‖xi‖2=r2\|x_{i}\|^{2}=r^{2} for some integer r2>0r^{2}>0; (ii)  _separation certificate_ : pairwise squared distances satisfy mini≠j⁡‖xi−xj‖2≥r2\min_{i\neq j}\|x_{i}-x_{j}\|^{2}\geq r^{2}. After appropriate scaling by t=2/r2t=2/\sqrt{r^{2}}, these vectors yield a valid kissing configuration with all sphere centers at radius 2 and pairwise distances at least 2.
Report issue for preceding element
The fitness metric is the cardinality NN of the constructed set. Validation employs exact integer arithmetic: squared norms are computed as ∑k=1nxi,k2\sum_{k=1}^{n}x_{i,k}^{2} using Python’s arbitrary-precision integers, and pairwise squared distances ‖xi−xj‖2\|x_{i}-x_{j}\|^{2} are checked exhaustively. The evolved programs must discover constructive algebraic methods—such as exploiting lattice symmetries, orbit decompositions, or algebraic number field constructions—rather than combinatorial enumeration, which becomes computationally infeasible at target scales.
Report issue for preceding element
We target dimension 12 with the goal of improving the established lower bound of N≥840N\geq 840.
Report issue for preceding element
#### Results.
Report issue for preceding element
We found that our default model _Qwen3-235B-A22B-Thinking-2507_ struggled to make progress on this problem, plateauing around fitness ∼500\sim 500. We replaced Qwen with Google Gemini-2.5-Flash comanici2025gemini, which readily achieved values of 840840 (the established lower bound). However, we were unable to improve beyond this value. This mirrors the findings in georgiev2025mathematical, where for most dimensions, the known lower bound was recovered but no improvements were achieved. We speculate that this construction is well-known and was present in the Gemini pre-training corpora. Overall, we believe the kissing number problem is one of the most challenging problems and can serve as a future benchmark.
Report issue for preceding element
###  4.3 Bin Packing
Report issue for preceding element
...
#### Problem Formulation.
Report issue for preceding element
We evaluate GigaEvo on The Jigsaw - Agile Community Rules Classification111<https://www.kaggle.com/competitions/jigsaw-agile-community-rules> competition hosted on the Kaggle platform. Given a Reddit comment cc and a subreddit rule rr, the task requires learning a function f:(c,r)→{0,1}f:(c,r)\rightarrow\\{0,1\\} that maps comment-rule pairs to binary labels, where 1 indicates a rule violation.
Report issue for preceding element
The dataset comprises 20482048 training examples and approximately 2020 times more test examples, with each instance containing the comment body, rule text, subreddit identifier, and few-shot demonstrations (two positive and two negative examples). Performance is evaluated using the per-rule Area Under the ROC Curve (AUC), averaged across all test rules. The test set includes 44 hidden rules unseen during training, challenging solution to generalize to novel community norms.
Report issue for preceding element
#### Experimental Setup.
Report issue for preceding element
We used Qwen2.5-14B-Instruct qwen2.5 as the base model to perform the classification task, with gpt-oss-120b openai2025gptoss120bgptoss20bmodel (high reasoning effort) serving as the evolutionary engine. The evolutionary process lasted approximately 6060 generations, with each prompt and agent candidate evaluated on the full training dataset.
Report issue for preceding element
...
#### Results.
Report issue for preceding element
The baseline prompt achieved AUC of 0.6730.673 on the training data and 0.6700.670 on the test data. After 6060 generations, GigaEvo was able to evolve the prompt that demonstrated substantial improvement, scoring 0.7940.794 AUC on the training data and 0.7830.783 on the test data, representing a 11.311.3 percentage points AUC gain on the test set. Incorporating an agent-based approach further yielded additional gains, achieving 0.8110.811 AUC on training data and 0.8030.803 on test data. Crucially, this agent remained computationally efficient by requiring only a single LLM call, similar to the evolved prompt configuration. The performance improvement was obtained by ensembling the LLM’s predicted probability with the precomputed Qwen embedding similarities through a calibrated sigmoid function. These experiments demonstrate that GigaEvo can discover effective architectures for integrating neural predictions with traditional feature-based methods.
Report issue for preceding element
##  5 Conclusions
Report issue for preceding element
...
Report issue for preceding element
The framework and all experimental code are available as open source at <https://github.com/AIRI-Institute/gigaevo-core>.
Report issue for preceding element
...
> Report issue for preceding element
>   1. 1.
> (Containment) All points lie inside or on the boundary of the enclosing triangle
> Report issue for preceding element
>   2. 2.
> (Distinctness) All points are distinct (no duplicates)
> Report issue for preceding element
>   3. 3.
> (Non-degeneracy) No three points are collinear
> Report issue for preceding element
>   4. 4.
> (Maximality) The minimum area among all (113)=165\binom{11}{3}=165 triangles is maximized
> Report issue for preceding element
> 
...
> Report issue for preceding element
>   * •
> get_smallest_triangle_area(coordinates) →\rightarrow float - minimum area among all (n3)\binom{n}{3} triangles
> Report issue for preceding element
>   * •
...
Generated by [ L A T E xml ![\[LOGO\]](/html/2511.17592v1/) ](https://math.nist.gov/~BMiller/LaTeXML/)
